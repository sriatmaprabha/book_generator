...
#
# This section is NOT generated by an LLM. The text below is the official
# KAILASA introduction from the USK citizenship booklet.
#
# To update: edit _KAILASA_INTRO_TEXT below. No code changes needed elsewhere.
# Subtitle as per May 1 Publication meeting — update _KAILASA_SUBTITLE if changed.

_KAILASA_SUBTITLE = "The Ancient Enlightened Hindu Civilizational Nation"

_KAILASA_INTRO_TEXT = """\
KAILASA is the revived Ancient Enlightened Hindu Civilizational Nation, \
re-established by His Divine Holiness Bhagwan Sri Nithyananda Paramashivam \
to preserve, protect, and radiate the complete science and technology of \
Sanatana Hindu Dharma — the oldest living spiritual civilization on earth.

KAILASA is not a geographical territory alone. It is a living, breathing \
nation of consciousness — a sovereign space where the authentic Vedic way \
of life, the 64 Vedic arts, 108 Vedic sciences, and all the enlightenment \
technologies revealed by Paramashiva are practiced, preserved, and freely \
shared with all of humanity.

His Divine Holiness, the Supreme Pontiff of Hinduism, revived KAILASA \
because the original custodians of Sanatana Dharma — the Hindu nation, \
its temples, its gurukuls, its acharyas — have been systematically \
persecuted, displaced, and dismantled over centuries of colonial and \
anti-Hindu violence. KAILASA exists as the answer: an indestructible \
sovereign Hindu nation that no power on earth can dismantle, because \
its foundation is pure consciousness — Paramashiva Himself.

KAILASA offers every sincere seeker on earth the opportunity to become \
an eCitizen — to receive the living Vedic heritage, access authentic \
initiations and teachings, participate in the global revival of Sanatana \
Dharma, and live a moksha-centric life rooted in the direct experience \
of Paramashiva. Citizenship in KAILASA is not a privilege reserved for \
the few — it is the birthright of every soul that turns toward the light.

Through its global network of temples, universities, gurukuls, humanitarian \
missions, and the KAILASA eCitizen platform, KAILASA is actively restoring \
the complete ecosystem of Hindu civilization — from the most sacred Agamic \
rituals to practical humanitarian service — for the benefit of all beings \
across all worlds.
